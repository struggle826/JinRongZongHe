...
class DataRead:
    def get_project_path(self):
        ...
        return dir_name + "\\"  #D:\ApiAutoTest\JinRongZongHe\
...
if __name__ == '__main__':
    ...
    # 注册
    value = DataRead().read_yaml(r"data_case/register_fail.yaml")
    print(value)
    print(DataRead().get_project_path())

    value = DataRead().read_yaml(r"data_case/register_success.yaml")
    print(value)
    print(DataRead().get_project_path())

    value = DataRead().read_yaml(r"data_case/register_repeat.yaml")
    print(value)
    print(DataRead().get_project_path())

    # 登录
    value = DataRead().read_yaml(r"data_case/login_fail.yaml")
    print(value)
    print(DataRead().get_project_path())

    value = DataRead().read_yaml(r"data_case/login_success.yaml")
    print(value)
    print(DataRead().get_project_path())